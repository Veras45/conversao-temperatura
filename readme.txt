...
docker build -t veras45/conversao-temperatura:v2 .

obs: essa build ja estava no mmeu docker hub, caso vc nao tenha, efetue um 'docker login' e crie sua imagem no seu docker hub usando o comando a cima. 
